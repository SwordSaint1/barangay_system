  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row">
            <div class="col-4">
              <label>Requester:</label> <input type="email" name="requester" id="requester" class="form-control" autocomplete="off" value="sample user" readonly>
            </div>
             <div class="col-4">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" data-dismiss="modal">Request Document</button>
